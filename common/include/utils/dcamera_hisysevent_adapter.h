...
const std::string DCAMERA_SINK_HEARTBEAT_RESPONSE_FAIL = "DCAMERA_SINK_HEARTBEAT_RESPONSE_FAIL";
const std::string DCAMERA_SOURCE_HEARTBEAT_SEND_FAIL = "DCAMERA_SOURCE_HEARTBEAT_SEND_FAIL";
const std::string DCAMERA_SINK_HEARTBEAT_TIMEOUT = "DCAMERA_SINK_HEARTBEAT_TIMEOUT";
const std::string DCAMERA_SOURCE_HEARTBEAT_TIMEOUT = "DCAMERA_SOURCE_HEARTBEAT_TIMEOUT";
...
const std::string DCAMERA_SINK_HEARTBEAT_RESPONSE_EVENT = "DCAMERA_SINK_HEARTBEAT_RESPONSE";
const std::string DCAMERA_SINK_HEARTBEAT_RECEIVED_EVENT = "DCAMERA_SINK_HEARTBEAT_RECEIVED";
const std::string DCAMERA_SOURCE_HEARTBEAT_SENT_EVENT = "DCAMERA_SOURCE_HEARTBEAT_SENT";
const std::string DCAMERA_SOURCE_HEARTBEAT_RECEIVED_EVENT = "DCAMERA_SOURCE_HEARTBEAT_RECEIVED";
const std::string DCAMERA_SOURCE_FIRST_HEARTBEAT = "DCAMERA_SOURCE_FIRST_HEARTBEAT";
