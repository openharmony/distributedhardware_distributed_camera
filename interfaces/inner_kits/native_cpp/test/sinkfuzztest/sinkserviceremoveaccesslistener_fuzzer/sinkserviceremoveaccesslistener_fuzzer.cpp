...
#include "sinkserviceremoveaccesslistener_fuzzer.h"
...
void SinkServiceRemoveAccessListenerFuzzTest(const uint8_t* data, size_t size)
{
    ...
    sinkService->RemoveAccessListener(pkgName);
}
}
}
...
{
    OHOS::DistributedHardware::SinkServiceRemoveAccessListenerFuzzTest(data, size);
    return 0;
}
