...
#include "sinkproxyreleasesink_fuzzer.h"
...
void SinkProxyReleaseSinkFuzzTest(const uint8_t* data, size_t size)
{
...
{
    OHOS::DistributedHardware::SinkProxyReleaseSinkFuzzTest(data, size);
    return 0;
}