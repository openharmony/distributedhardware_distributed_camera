...
#ifndef OHOS_DCAMERA_CHANNEL_SINK_IMPL_H
#define OHOS_DCAMERA_CHANNEL_SINK_IMPL_H
...
class DCameraChannelSinkImpl : public ICameraChannel {
public:
    DCameraChannelSinkImpl();
    ~DCameraChannelSinkImpl() override;
