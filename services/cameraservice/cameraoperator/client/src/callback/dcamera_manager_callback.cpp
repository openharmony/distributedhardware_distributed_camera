...
{
    DHLOGI("enter, cameraStatus: %{public}d", cameraStatusInfo.cameraStatus);
}
...
{
    DHLOGI("enter, cameraID: %{public}s, flashStatus: %{public}d", GetAnonyString(cameraID).c_str(), flashStatus);
}
} // namespace DistributedHardware
} // namespace OHOS