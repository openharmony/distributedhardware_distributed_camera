 ...
 */
#ifndef OHOS_DCAMERA_OPEN_INFO_H
#define OHOS_DCAMERA_OPEN_INFO_H
...
class DCameraOpenInfoCmd {
public:
    std::string type_;
    std::string dhId_;
    std::string command_;
    std::shared_ptr<DCameraOpenInfo> value_;
...
#endif // OHOS_DCAMERA_OPEN_INFO_H
