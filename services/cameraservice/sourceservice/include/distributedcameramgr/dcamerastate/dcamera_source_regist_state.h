...
#ifndef OHOS_DCAMERA_SOURCE_REGIST_STATE_H
#define OHOS_DCAMERA_SOURCE_REGIST_STATE_H
...
public:
    ...
    ~DCameraSourceRegistState() override {}
...
#endif // OHOS_DCAMERA_SOURCE_REGIST_STATE_H
