...
#ifndef OHOS_DCAMERA_SOURCE_OPENED_STATE_H
#define OHOS_DCAMERA_SOURCE_OPENED_STATE_H
...
public:
    DCameraSourceOpenedState(std::shared_ptr<DCameraSourceStateMachine>& stateMachine);
...
private:
    ...
    using DCameraFunc = int32_t (DCameraSourceOpenedState::*)(std::shared_ptr<DCameraSourceDev>& camDev,
